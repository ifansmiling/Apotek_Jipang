...
<div class="page-header">
    ...
    <div>
        <ol class="breadcrumb">
            <li class="breadcrumb-item text-gray">Master Obat</li>
...
@include('Admin.Barang.tambah', ['jenisbarang' => $jenisbarang, 'satuan' => $satuan, 'merk' => $merk, 'customer' => $customer])
@include('Admin.Barang.edit', ['jenisbarang' => $jenisbarang, 'satuan' => $satuan, 'merk' => $merk, 'customer' => $customer])
...
<script>
    ...
    function update(data){
        ...
        $("input[name='kodeU']").val(data.barang_kode.replace(/_/g, ' '));
